...
_gmic()
{
    ...
    coms="!= % & *3d * +3d + -3d - /3d / << <= < == = >= >> > ^ a abs ac acos acosh add3d add adjust_colors alert and animate3d animate ap apc apo append append_tiles apply_camera3d apply_camera apply_channels apply_curve apply_files apply_gamma apply_matrix3d apply_parallel apply_parallel_channels apply_parallel_overlap apply_scales apply_tiles apply_timeout apply_video area area_fg arg0 arg2var arg argmax argmaxabs argmin argminabs array3d array array_fade array_mirror array_random arrow3d arrow asin asinh at at_line at_quadrangle atan2 atan atanh autocrop autocrop_components autocrop_coords autocrop_seq autoindex average_colors average_files average_video axes3d axes b balance_gamma ball bandpass barycenter base642img base642uchar basename bayer2rgb bilateral bin2dec bin blend blend_edges blend_fade blend_median blend_seamless blur blur_angular blur_bloom blur_linear blur_radial blur_selective blur_x blur_xy blur_xyz blur_y blur_z boundingbox3d box3d boxfilter boxfitting break brushify bsl bsr bump2normal c3d c camera cartoon cast center3d channels check3d check check_display chessboard cie1931 circle3d circle circles3d close_binary clut cmy2rgb cmyk2rgb col3d color3d color_ellipses colorblind colorcube3d colormap columns command complex2polar compose_channels compose_freq compress_clut compress_rle cone3d continue convolve convolve_fft correlate cos cosh covariance_colors cracks crop cross_correlation cubes3d cubism cumulate cup3d cursor curvature cut cylinder3d d0 d2d d3d d da db3d dc dct deblur deblur_goldmeinel deblur_richardsonlucy debug dec2bin dec2hex dec2oct dec2str dec decompress_clut decompress_clut_pde decompress_clut_rbf decompress_rle deconvolve_fft deform deinterlace delaunay3d delaunay deltaE demos denoise denoise_haar denoise_patchpca deriche detect_skin dfft dg dh diagonal diffusiontensors dijkstra dilate dilate_circ dilate_oct dilate_threshold direction2rgb discard displacement display0 display2d display3d display display_array display_camera display_fft display_graph display_histogram display_parallel0 display_parallel display_parametric display_polar display_quiver display_rgba display_tensors display_warp distance distribution3d ditheredbw div3d div div_complex divergence do dog done double3d dp0 dp dq draw_whirl drawing drgba drop_shadow dt dw e echo echo_file echo_stdout edges eigen2tensor eigen elevate elevation3d elif ellipse ellipsionism else empty3d endian endl endlocal eq equalize equirectangular2nadirzenith erode erode_circ erode_oct erode_threshold error euclidean2polar eval exec exp expand_x expand_xy expand_xyz expand_y expand_z extract extract_region extrude3d f3d f fact fade_diamond fade_files fade_linear fade_radial fade_video fade_x fade_y fade_z fc fft fftpolar fi fibonacci file_mv file_rand file_rm filename files2video files fill fill_color fire_edges fisheye fitratio_wh fitscreen flood flower focale3d fontchart for fps fractalize frame frame_blur frame_cube frame_fuzzy frame_painting frame_pattern frame_round frame_seamless frame_x frame_xy frame_xyz frame_y function1d funny_oneliners g gaussian gaussians3d gcd ge glow gmic3d gradient2rgb gradient gradient_norm gradient_orientation graph grid gt guided gyroid3d h haar halftone hardsketchbw hcy2rgb hearts heat_flow help hessian hex2dec hex2img8 hex2img hex2str hex histogram3d histogram histogram_cumul histogram_nd histogram_pointwise hough houghsketchbw hsi2rgb hsi82rgb hsl2rgb hsl82rgb hsv2rgb hsv82rgb i idct iee if ifft ifftpolar ig ihaar ilaplacian image6cube3d image imageblocks3d imagecube3d imagegrid imagegrid_hexagonal imagegrid_triangular imageplane3d imagepyramid3d imagerubik3d imagesphere3d img2ascii img2base64 img2hex img2str img2text img82hex index inn inpaint inpaint_flow inpaint_holes inpaint_matchpatch inpaint_morpho inpaint_pde input input_565 input_cube input_flo input_glob input_gpl input_text inrange int2rgb invert ir is_3d is_change is_ext is_half is_image_arg is_macos is_pattern is_percent is_variable_name is_videofilename is_windows isoline3d isophotes isosurface3d it j3d j jzazbz2rgb jzazbz2xyz k kaleidoscope keep kuwahara l3d l laar lab2lch lab2rgb lab2srgb lab2xyz lab82rgb lab82srgb label3d label label_fg label_points3d laplacian lathe3d lch2lab lch2rgb lch82rgb le lic light3d light_patch light_relief lightness lightrays line3d line linearize_tiles linethick linify lissajous3d local log10 log2 log lt luminance lut_contrast m* m/ m3d m mad mandelbrot map map_clut map_sphere map_sprites map_tones map_tones_fast marble matchpatch math_lib max max_d max_h max_patch max_s max_w max_wh max_whd max_whds maxabs maze maze_mask md3d mdiv meancurvature_flow med median median_color median_files median_video min min_d min_h min_patch min_s min_w min_wh min_whd min_whds minabs minimal_path mirror mix_channels mix_rgb mmul mod mode3d moded3d montage morph morph_files morph_rbf morph_video mosaic move mproj mse mul3d mul mul_channels mul_complex mutex mv n3d n nadirzenith2equirectangular name named negate neq network newton_fractal nlmeans nlmeans_core nm nmd nn_backpropagate nn_backpropagate_batch nn_input nn_new_fullyconnected nn_new_input nn_new_output nn_output nn_propagate nn_propagate_batch nn_serialize nn_unserialize nn_update noarg noise noise_hurl noise_perlin noise_poissondisk norm normalize3d normalize normalize_filename normalize_local normalize_sum normalized_cross_correlation normp not o3d o object3d oct2dec oct oklab2rgb old_photo on oneminus onfail op opacity3d or orientation orthogonalize ot otsu output output_565 output_cube output_flo output_ggr output_obj output_text outputn outputp outputw outputx ow ox p3d p pack pack_sprites padint palette parallel parametric3d parse_cli parse_gui pass patches path_cache path_current path_gimp path_tmp pca_patch3d pde_flow pencilbw percentile periodize_poisson permute peronamalik_flow phase_correlation piechart pixelize pixelsort plane3d plasma plot2value plot point3d point pointcloud3d pointcloud polar2complex polar2euclidean polaroid polka_dots polygon polygonize pose3d poster_edges poster_hope pow primitives3d print progress projections3d pseudogray psnr puzzle pyramid3d q quadrangle3d quadratize_tiles quantize quantize_area quit quiver r2dx r2dy r3d r3dx r3dy r3dz r raindrops rand random3d random_pattern rbf rectangle red_eye register_nonrigid register_rigid remove remove_copymark remove_duplicates remove_empty remove_hotpixels remove_named remove_opacity remove_pixels repeat replace replace_color replace_inf replace_nan replace_naninf replace_seq replace_str reset resize2dx resize2dy resize3dx resize3dy resize3dz resize resize_as_image resize_mn resize_pow2 resize_ratio2d retinex return reverse3d reverse rgb2bayer rgb2cmy rgb2cmyk rgb2hcy rgb2hsi8 rgb2hsi rgb2hsl8 rgb2hsl rgb2hsv8 rgb2hsv rgb2int rgb2jzazbz rgb2lab8 rgb2lab rgb2lch8 rgb2lch rgb2luv rgb2oklab rgb2ryb rgb2srgb rgb2xyz8 rgb2xyz rgb2ycbcr rgb2yiq8 rgb2yiq rgb2yuv8 rgb2yuv rgb rgba ri ripple rm rmn rodilius rol rolling_guidance ror rorschach rotate3d rotate rotate_tileable rotate_tiles rotation3d rotoidoscope round roundify rows rprogress rr2d run rv3d rv ryb2rgb s3d s sample scale2x scale3x scale_dcci2x scanlines screen seamcarve segment_watershed select select_color sepia serialize set sh shade_stripes shadow_patch shape2bump shape_circle shape_cupid shape_diamond shape_dragon shape_fern shape_gear shape_heart shape_polygon shape_snowflake shape_star shared sharpen shift shift_tiles shrink_x shrink_xy shrink_xyz shrink_y shrink_z sierpinski3d sierpinski sign sin sinc sinh size3d size_value skeleton3d skeleton sketchbw skip sl3d slic slices smooth snapshot3d solarize solidify solve solve_poisson sort sort_list sp specl3d specs3d sphere3d spherical3d spherize spiralbw spline3d spline split3d split split_colors split_details split_freq split_opacity split_tiles sponge spread sprite3d sprites3d sqr sqrt srand srgb2lab8 srgb2lab srgb2rgb ss3d ssd_patch stained_glass star3d stars status std_noise stencil stencilbw store str2hex str strcapitalize strcontains streamline3d stripes_y strlen strlowercase strreplace structuretensors struppercase strvar strver stylize sub3d sub sub_alpha superformula3d svd symmetrize syntexturize syntexturize_matchpatch t3d t tan tanh taquin tensors3d testimage2d tetraedron_shade tetris text3d text text_outline text_pointcloud3d texturize3d texturize_canvas texturize_paper thinning threshold tic tixy to to_a to_clutname to_color to_colormode to_gray to_graya to_pseudogray to_rgb to_rgba toc tones topographic_map torus3d transfer_histogram transfer_pca transfer_rgb transform_polar transition3d transition transpose triangle3d triangle_shade trisolve truchet tsp tunnel turbulence tv_flow twirl u uchar2base64 um uncommand undistort uniform_distribution unroll unserialize unsharp unsharp_octave up update upscale_smart v vanvliet variance_patch vector2tensor verbose version video2files vignette volume3d voronoi w wait warhol warn warp warp_patch warp_perspective warp_rbf water watermark_fourier watermark_visible watershed wave weave weird3d while whirls wind window x x_2048 x_blobs x_bouncing x_color_curves x_colorize x_connect4 x_crop x_cut x_fire x_fireworks x_fisheye x_fourier x_grab_color x_hanoi x_histogram x_hough x_jawbreaker x_landscape x_life x_light x_mandelbrot x_mask_color x_metaballs3d x_minesweeper x_minimal_path x_morph x_pacman x_paint x_plasma x_quantize_rgb x_reflection3d x_rubber3d x_segment x_select_color x_select_function1d x_select_palette x_shadebobs x_spline x_starfield3d x_tetris x_threshold x_tictactoe x_warp x_waves x_whirl xor xyz2jzazbz xyz2lab xyz2rgb xyz82rgb xz y ycbcr2rgb yinyang yiq2rgb yiq82rgb yuv2rgb yuv82rgb z zoom |"
    ...
    case "${prev}" in
        ...
        "base642uchar" | "-base642uchar" | "+base642uchar")
            COMPREPLY=( $(compgen -W "> \"base64_string\"") ); return 0;;
        ...
        "correlate" | "-correlate" | "+correlate")
            COMPREPLY=( $(compgen -W "> [mask],_boundary_conditions,_is_normalized={_0_|_1_},_channel_mode,_xcenter,_ycenter,_zcenter,_xstart,_ystart,_zstart,_xend,_yend,_zend,_xstride,_ystride,_zstride,_xdilation,_ydilation,_zdilation") ); return 0;;
        "covariance_colors" | "-covariance_colors" | "+covariance_colors")
        ...
        "echo_stdout" | "-echo_stdout" | "+echo_stdout")
            COMPREPLY=( $(compgen -W "> message") ); return 0;;
        "edges" | "-edges" | "+edges")
        ...
        "nmd" | "-nmd" | "+nmd")
            COMPREPLY=( $(compgen -W "> _mode,\"name1\",\"name2\",...") ); return 0;;
        "nn_backpropagate" | "-nn_backpropagate" | "+nn_backpropagate")
            COMPREPLY=( $(compgen -W "> module_name,[expected_output],_loss_function") ); return 0;;
        "nn_backpropagate_batch" | "-nn_backpropagate_batch" | "+nn_backpropagate_batch")
        ...
        "nn_input" | "-nn_input" | "+nn_input")
            COMPREPLY=( $(compgen -W "> \"filename\"") ); return 0;;
        "nn_new_fullyconnected" | "-nn_new_fullyconnected" | "+nn_new_fullyconnected")
            COMPREPLY=( $(compgen -W "> module_name,previous_module_name,nb_neurons,activation_function") ); return 0;;
        "nn_new_input" | "-nn_new_input" | "+nn_new_input")
            COMPREPLY=( $(compgen -W "> module_name,width,_height,_spectrum") ); return 0;;
        "nn_new_output" | "-nn_new_output" | "+nn_new_output")
            COMPREPLY=( $(compgen -W "> module_name,previous_module_name") ); return 0;;
        "nn_output" | "-nn_output" | "+nn_output")
            COMPREPLY=( $(compgen -W "> module_name,filename") ); return 0;;
        "nn_propagate" | "-nn_propagate" | "+nn_propagate")
            COMPREPLY=( $(compgen -W "> module_name") ); return 0;;
        "nn_propagate_batch" | "-nn_propagate_batch" | "+nn_propagate_batch")
            COMPREPLY=( $(compgen -W "> module_name,[inputs_zstacked]") ); return 0;;
        "nn_serialize" | "-nn_serialize" | "+nn_serialize")
            COMPREPLY=( $(compgen -W "> module_name,_is_compressed={_0_|_1_}") ); return 0;;
        "nn_update" | "-nn_update" | "+nn_update")
        ...
        "u" | "-u" | "+u")
            COMPREPLY=( $(compgen -W "> status_string") ); return 0;;
        "uchar2base64" | "-uchar2base64" | "+uchar2base64")
