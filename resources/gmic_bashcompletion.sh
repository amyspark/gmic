...
_gmic()
{
    ...
    case "${prev}" in
        ...
        "==" | "-==" | "+==")
            COMPREPLY=( $(compgen -W "value[%] [image] \'formula\' (no_arg)") ); return 0;;
        "=>" | "-=>" | "+=>")
            COMPREPLY=( $(compgen -W "> \"name1\",\"name2\",...,\"nameN\"") ); return 0;;
        "=" | "-=" | "+=")
        ...
        "cat" | "-cat" | "+cat")
            COMPREPLY=( $(compgen -W "> filename,_display_line_numbers={_0_|_1_},_line_selection,") ); return 0;;
        ...
        "circles3d" | "-circles3d" | "+circles3d")
            COMPREPLY=( $(compgen -W "> _radius>=0,_is_outlined={_0_|_1_}") ); return 0;;
        ...
        "color2name" | "-color2name" | "+color2name")
            COMPREPLY=( $(compgen -W "> R,G,B") ); return 0;;
        ...
        "filename_dated" | "-filename_dated" | "+filename_dated")
        ...
        "match_histogram" | "-match_histogram" | "+match_histogram")
            COMPREPLY=( $(compgen -W "> [reference_image],_nb_levels>0,_color_channels") ); return 0;;
        "match_icp" | "-match_icp" | "+match_icp")
            COMPREPLY=( $(compgen -W "> [reference_image],_precision>0,_transformation_variable") ); return 0;;
        "match_pca" | "-match_pca" | "+match_pca")
            COMPREPLY=( $(compgen -W "> [reference_image],_color_channels") ); return 0;;
        "match_rgb" | "-match_rgb" | "+match_rgb")
        ...
        "name2color" | "-name2color" | "+name2color")
        ...
        "nn_append" | "-nn_append" | "+nn_append")
            COMPREPLY=( $(compgen -W "> out,in0,_in1") ); return 0;;
        "nn_avgpool2d" | "-nn_avgpool2d" | "+nn_avgpool2d")
        ...
        "nn_distance" | "-nn_distance" | "+nn_distance")
            COMPREPLY=( $(compgen -W "> out,in0,_in1,_metric={_0=squared-L2_|_p>0_=_Lp-norm_}") ); return 0;;
        ...
        "nn_loss_crossentropy" | "-nn_loss_crossentropy" | "+nn_loss_crossentropy")
            COMPREPLY=( $(compgen -W "> out,in,ground_truth") ); return 0;;
        "nn_loss_mse" | "-nn_loss_mse" | "+nn_loss_mse")
            COMPREPLY=( $(compgen -W "> out,in,ground_truth") ); return 0;;
        "nn_loss_normp" | "-nn_loss_normp" | "+nn_loss_normp")
            COMPREPLY=( $(compgen -W "> out,in,ground_truth,_metric={_0=squared-L2_|_p>0_=_Lp-norm_}") ); return 0;;
        ...
        "nn_maxpool2d" | "-nn_maxpool2d" | "+nn_maxpool2d")
            COMPREPLY=( $(compgen -W "> out,_in,_patch_size>1") ); return 0;;
        "nn_maxpool3d" | "-nn_maxpool3d" | "+nn_maxpool3d")
            COMPREPLY=( $(compgen -W "> out,_in,_patch_size>1") ); return 0;;
        "nn_mul" | "-nn_mul" | "+nn_mul")
            COMPREPLY=( $(compgen -W "> out,in0,_in1") ); return 0;;
        "nn_nl" | "-nn_nl" | "+nn_nl")
        ...
        "nn_patchdown2d" | "-nn_patchdown2d" | "+nn_patchdown2d")
            COMPREPLY=( $(compgen -W "> out,_in,_patch_size>1") ); return 0;;
        "nn_patchdown3d" | "-nn_patchdown3d" | "+nn_patchdown3d")
            COMPREPLY=( $(compgen -W "> out,_in,_patch_size>1") ); return 0;;
        "nn_patchup2d" | "-nn_patchup2d" | "+nn_patchup2d")
            COMPREPLY=( $(compgen -W "> out,_in,_patch_size>1") ); return 0;;
        "nn_patchup3d" | "-nn_patchup3d" | "+nn_patchup3d")
            COMPREPLY=( $(compgen -W "> out,_in,_patch_size>1") ); return 0;;
        ...
        "random_clut" | "-random_clut" | "+random_clut")
            COMPREPLY=( $(compgen -W "> _seed_=_{_>=0_|_-1_}") ); return 0;;
        ...
        "shape_heart" | "-shape_heart" | "+shape_heart")
            COMPREPLY=( $(compgen -W "> _size>=0") ); return 0;;
        "shape_menger" | "-shape_menger" | "+shape_menger")
            COMPREPLY=( $(compgen -W "> _nb_iterations>=0") ); return 0;;
        "shape_mosely" | "-shape_mosely" | "+shape_mosely")
            COMPREPLY=( $(compgen -W "> _nb_iterations>=0") ); return 0;;
        ...
        "sphere3d" | "-sphere3d" | "+sphere3d")
            COMPREPLY=( $(compgen -W "radius,_nb_recursions!=0 radius,_nb_phi>=3,_nb_theta>=3") ); return 0;;
        "spherical3d" | "-spherical3d" | "+spherical3d")
            COMPREPLY=( $(compgen -W "\"radius_function(phi,theta)\",_nb_recursions!=0 \"radius_function(phi,theta)\",_nb_phi>=3,_nb_theta>=3") ); return 0;;
        ...
        "voxelize3d" | "-voxelize3d" | "+voxelize3d")
            COMPREPLY=( $(compgen -W "> _max_resolution>0,_fill_interior={_0_|_1_},_preserve_colors={_0_|_1_}") ); return 0;;
        "w" | "-w" | "+w")
